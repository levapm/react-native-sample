...
export default {
    ...
    // Badge
    badgeBg: color(colors.light).darken(0.3).hex(),
    ...
    // FooterTab
    tabBarTextColor: color(colors.primary).lighten(0.3).hex(),
    ...
    toolbarBtnTextColor: colors.light,
